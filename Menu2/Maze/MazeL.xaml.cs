...
namespace Menu2.Maze
{
    public partial class MazeL : Page
    {
        ...
        GamePlay spawn;
        public int number;
        public MazeL(string direction, GamePlay spawn, int number)
        {
            InitializeComponent();
            this.spawn = spawn;
            this.number = number;
        ...
        public void DropPinCode()
        {
            ...
            // Загружаем картинку из ресурсов проекта
            code.Source = new BitmapImage(new Uri($"Code{number}(4).png", UriKind.RelativeOrAbsolute));
            code.Tag = "code";
